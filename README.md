...
# STO SE TICE KADINOG RESENJA, ONO JE NESTO DRUGACIJE, A POSTO JA NEMAM VREMENA ZA REVIEW ILI NESTO SLICNO SAMO OSTAVLJAM LINK TOG RESENJA

<https://kadikraman.github.io/react-native-v2/forms-exercise-solution>

# MEDJUTIM ZABORAVIO SAM DA ODRADIM PRAVI ERROR HANDLING, ODNONO DA ALERT-UJEM KORISNIKA KAO NIJE UNEO ONO STA TREBA, A TO JE TREBALO DA SE DESI U SUBMIT FUNKCIJI (JA ZA SADA IMAM SAMO `onPress`, ALI SVU LOGIKU MOGU PREBACITI U NOVU FUNKCIJU I TU ODRADITI TAJ 'ERROR HANDLING' )

DAKLE NAJVAZNIJA STVAR KOJU CU URADITI OVDE JE KORISCENJE **`Alert`** OBJEKAT IZ 'react-native', I OBJEKTOVE METODE **`alert`**
