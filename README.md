...
- `touch components/AddNewPaletteModal.tsx` (`MOZDA JE OVO TREBAL ODA SE NADJE U screen FOLDERU ZATO STO TO I JESTE: 'MODAL SCREEN', ALI NEMA VEZE`)
...
## STA JE USTVARI POSTIGNUTO SAM KORISCENJEM MODLA

PA POSTIGNUTO JE DA SE USTVARI NE NAVIGATE-UJE OF THE SCREEN SA KOJEG SI INICIRAO NAVIGATING TO MODAL

ON OSTAJE OTVOREN A MODAL PREKRIVA PAGE

EVO STA JE REKLA KADI:

>> There you go, so the cool thing about it, is that the way we navigate is actually the same between modals and just going into different screens.
>> I SAV POSAO O TOME KAKO OVO DEFINISATI BILO JE INSIDE App.tsx

I AKO ZELIS DA DODAS JOS MODALA TI MOZES DODADTI JOS SCREEN-OVA U App.tsx

## ZASTO SAM U MOM PRIMERU PRAVIO MODAL

NA HOME SCREEN-U JE PRIKAZAN PREVIEW BOJA UZ PRISUTNOST TOUCHABLE OPACITY-JA

JA ZELIM DA OTVORIM MODAL I DA U MODALU UNESEM NOVU COLOR SCHEMA-U, UZ KORISCENJE FORM KOMPONENTI

I ZELIM DA SE NOVA SCHEMA, USTVARI DODA POSTOJECOJ LISTI NA HOME PAGE, ODNONO NA NJEN VRH

## JA CU U SLEDECEM BRANCHU UPRAVO DEFINISATI TAJ FORM INSIDE MODAL